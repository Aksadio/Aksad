...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Visit%20Site-white?style=flat-square&logo=github)](https://aksadio.github.io/aksad-profile)
...
```bash
# Clone the repo
git clone https://github.com/Aksadio/aksad-profile.git
cd aksad-profile
...
|---|---|---|
| aksad-profile | HTML, JS, CSS | This portfolio |
